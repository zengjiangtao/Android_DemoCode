...
import com.android.camera.ui.TextTipsView;
...
public class CaptureModuleUI implements PreviewStatusListener.PreviewAreaChangedListener {
	...
	private final TextTipsView mTextTipsView;
    ...
    public CaptureModuleUI(CameraActivity activity, View parent, CaptureModuleUIListener listener) {
		...
		mTextTipsView = (TextTipsView) mRootView.findViewById(R.id.text_tips_view);
    }
    ...
    public void ShowTips(String str){
		mTextTipsView.ShowTips(str);
	}

	public void HideTips(){
		mTextTipsView.HideTips();
	}
